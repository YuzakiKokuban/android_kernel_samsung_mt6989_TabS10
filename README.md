...
这是一个基于三星官方内核源码构建的，适用于 **三星 Galaxy Tab S10 系列** 的高性能自定义内核。它旨在提供卓越的稳定性和流畅度，同时集成了最新的 KernelSU 功能，为您带来最佳的玩机体验。
...
* **版本信息**: `-android14-Kokuban-Exusiai-BYE1`
...
* **Version Info**: `-android14-Kokuban-Exusiai-BYE1`
